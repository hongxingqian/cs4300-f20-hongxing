const webglUtils7 = {
    ...
    rgbToHex: (rgb) => {
        const redHex = webglUtils7.componentToHex(rgb.red * 256)
        const greenHex = webglUtils7.componentToHex(rgb.green * 256)
        const blueHex = webglUtils7.componentToHex(rgb.blue * 256)
    ...
    updateColor: (event) => {
        ...
        const rgb = webglUtils7.hexToRgb(hex)
    ...
    doMouseDown: (event) => {
        ...
        webglUtils7.addShape(shape, shapeType)
    },
    renderCube: (cube) => {
        const geometry = [
            0,  0,  0,    0, 30, 0,    30,  0,  0,
