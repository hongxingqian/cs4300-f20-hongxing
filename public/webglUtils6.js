const webglUtils6 = {
    ...
    rgbToHex: (rgb) => {
        const redHex = webglUtils6.componentToHex(rgb.red * 256)
        const greenHex = webglUtils6.componentToHex(rgb.green * 256)
        const blueHex = webglUtils6.componentToHex(rgb.blue * 256)
    ...
    updateColor: (event) => {
        ...
        const rgb = webglUtils6.hexToRgb(hex)
    ...
    doMouseDown: (event) => {
        ...
        webglUtils6.addShape(shape, shapeType)
    },
    renderCube: (cube) => {
        const geometry = [
            0,  0,  0,    0, 30, 0,    30,  0,  0,
